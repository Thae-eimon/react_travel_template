...
const Footer = () => {
  return (
    <div className='w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2'>
        ...
        <div className='max-w-[1400px] text-gray-500  text-center  flex flex-col mx-auto justify-between  px-2 py-4 sm:flex-row '>
            <p className='py-4'>2023 Travel Tales, LLC. All rights reserved</p>
